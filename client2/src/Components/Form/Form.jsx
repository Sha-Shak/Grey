...
const Form = () => {
  ...
  const onePost = useSelector(state=> editId ? state.posts.find((post)=> post._id === editId) : null);
  console.log("form", onePost);
  ...
  return (
    <Paper>
      <form onSubmit={handleSubmit}>
        ...
        <TextField name="title" variant = "outlined" label="Title" fullWidth value={  postData.title } onInput={(e)=> setPostData({...postData, title: e.target.value})} />
